...
chcp 65001 >nul
echo ========================================
echo LingShu IMA Knowledge Base Downloader V3.0
echo ========================================
echo.

REM Set encoding
set JAVA_TOOL_OPTIONS=-Dfile.encoding=UTF-8 -Dstdout.encoding=UTF-8 -Dstderr.encoding=UTF-8 -Dsun.jnu.encoding=UTF-8
